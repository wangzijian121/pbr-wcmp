...
import com.zlht.pbr.algorithm.wcmp.interceptor.LoginHandlerInterceptor;
...
public class AppConfiguration implements WebMvcConfigurer {
    ...
    public static final String LOGIN_PATH_PATTERN_WCMP = "/wcmp/login";
   ...
   /*     registry.addInterceptor(loginInterceptor())
                ...
                .excludePathPatterns(LOGIN_PATH_PATTERN, LOGIN_PATH_PATTERN_wcmp, REGISTER_PATH_PATTERN,
